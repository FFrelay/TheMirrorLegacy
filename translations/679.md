...
Many arts could create illusory clones, but when one tried to use an artifact of profound light to see through a technique based on Sky Glow, they canceled each other out. The user would see nothing.
...
A torrent of apricot-yellow flame erupted from his mouth, swelling into a massive, incandescent sphere in the air. In an instant, it burst like a shattered silver vase, unleashing a countless number of Virile Fire sparks.
