<!-- NAV START -->
[Previous Chapter](./1104.md) | [TOC](./) | [Next Chapter](./1106.md)
<!-- NAV END -->

# Chapter 1105: The Silver Drum
...
He watched as the malevolent qi was beaten into a pained, steady retreat. If not for a divine ability sustaining it, its foundation would have already been damaged. The youth’s expression, however, remained utterly unmoved, as if this was all expected.
...
'That silver lightning specifically targets light and malevolent qi. It must be designed for large-scale spell-type divine abilities and some manifested, drifting Body Divine Abilities...'
...
Li Zhouwei's eyes narrowed slightly. He spoke with keen interest, "I'd say not necessarily."
