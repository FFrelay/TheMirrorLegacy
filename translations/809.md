...
He mused internally, 'The Chengyun Gate built an underground palace. I heard its deepest part lies beneath Xiaoshi Mountain. Perhaps it’s related to the Secret Diffusion Dao lineage... Secret Diffusion, Secret Diffusion... both are of the Encompassing Profoundity. Their ancestors were the same branch.'
...
'Earlier, I speculated the Immortal Mirror was an immortal artifact from the Moonlight Origin Mansion. But how is it suddenly connected to Encompassing Profoundity? Since the Moonlight Origin Mansion shares its source with the Supreme Yin Daoist tradition, it definitely shouldn't be the same path as Encompassing Profoundity. If it is, then something is wrong...'
